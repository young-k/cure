...
extension UIColor {
    static let coralPink = UIColor(red: 255/255, green: 92/255, blue: 112/255, alpha: 1.0)
    static let cureIndigo = UIColor(red: 70/255, green: 44/255, blue: 216/255, alpha: 1.0)
    static let cyanGreen = UIColor(red: 82/255, green: 223/255, blue: 191/255, alpha: 1.0)
